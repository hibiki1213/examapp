...
export default function HealthEconomicsCategoryPage() {
  ...
  useEffect(() => {
    const fetchCategoryData = async () => {
      try {
        setIsLoading(true)
        const response = await fetch(`/api/health-economics/categories/${categoryId}`)
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {session.isCompleted ? (
          <FinalResults
            ...
            homeLink="/health-economics"
            homeLabel="医療経済学のカテゴリ一覧に戻る"
          />
        ) : currentResult ? (
          <ResultDisplay
