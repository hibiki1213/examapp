...
export default function IndustrialOrganizationCategoryPage() {
  ...
  useEffect(() => {
    const fetchCategoryData = async () => {
      try {
        setIsLoading(true)
        const response = await fetch(`/api/industrial-organization/categories/${categoryId}`)
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        {session.isCompleted ? (
          <FinalResults
            ...
            homeLink="/industrial-organization"
            homeLabel="産業組織論のカテゴリ一覧に戻る"
          />
        ) : currentResult ? (
          <ResultDisplay
